 ...
 * @author Прохоров Д.С.
 */
public class Helicopter extends FlyApparat {
    ...
    public Helicopter(String firma, int passengers, String types, int powers) {
        super(firma, passengers);
        type = types;
        power = powers;
    }
    /**
     * Устанавливает значение поля {@link Helicopter#type}
     * @param types - тип вертолета */
    public void setType(String types) {
        type = types;
    }
    /**
     * Устанавливает значение поля {@link Helicopter#power}
     * @param powers - мощность вертолета */
    public void setPower(int powers) {
        power = powers;
    }
    /**
     * Возвращает значение поля {@link Helicopter#type}
     * @return строку с типом вертолета */
    public String getType() {
        return type;
    }
    /**
     * Возвращает значение поля {@link Helicopter#power}
